...
> **Status: v1.0.2.** Plotterosaurus is a fork of [Plotter Hub](https://github.com/Synendo/PlotterHub), with version numbering restarted at `1.0.0` to reflect that this is a separate line rather than a continuation of upstream's releases.
>
